...
testcover:
	...
	TF_ACC=1 gotestsum --junitfile report.xml --format testname --raw-command go test --cover --timeout 10s --tags musl  --coverprofile=coverage.txt --covermode=atomic --coverpkg "$(shell go list ./...  | tr '\n' ",")" --json ./... 
