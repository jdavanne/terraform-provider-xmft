...
page_title: "xmft_st_subscription_human_to_system Resource - xmft"
subcategory: ""
description: |-
  
---

# xmft_st_subscription_human_to_system (Resource)
...
- `file_filter_pattern` (String) default:'', <nil>
- `recipient_pattern` (String) default:'', <nil>
- `target_folder` (String) default:'', <nil>
