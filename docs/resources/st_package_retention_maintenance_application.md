...
page_title: "xmft_st_package_retention_maintenance_application Resource - xmft"
subcategory: ""
description: |-
  
---

# xmft_st_package_retention_maintenance_application (Resource)
...
- `max_running_minutes` (Number) default:0, The maximum number of minutes the application runs each time it is started.
...
- `type` (String) default:PackageRetentionMaint, <nil>
