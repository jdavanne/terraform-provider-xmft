...
page_title: "xmft_st_subscription_standard_router Resource - xmft"
subcategory: ""
description: |-
  
---

# xmft_st_subscription_standard_router (Resource)
...
- `subscriber_id` (String) default:'', The subscriber ID.
