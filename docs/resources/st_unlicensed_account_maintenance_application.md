...
page_title: "xmft_st_unlicensed_account_maintenance_application Resource - xmft"
subcategory: ""
description: |-
  
---

# xmft_st_unlicensed_account_maintenance_application (Resource)
...
- `inactive_period` (Number) default:0, Specify how long in days an unlicensed account must be inactive before it is deleted.
...
- `type` (String) default:UnlicensedAccountMaint, <nil>
